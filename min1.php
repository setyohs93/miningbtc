...
function call($addr) {
    ...
    $c = curl_init("https://www.thebestbitcoinfaucet.com/?refid=19794");
    curl_setopt($c, CURLOPT_REFERER, "https://www.thebestbitcoinfaucet.com/?refid=19794");
...
for($i=0; $i<100; $i++) {
    ...
    echo "[" . date("H:i:s") . "] Mohon Tunggu 60 Detik...\n";
    sleep(60);
}
